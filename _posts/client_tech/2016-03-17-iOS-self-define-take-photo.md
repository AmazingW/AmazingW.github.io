...
@protocol CapturePhotoDelegate <NSObject>
@optional
...
#define kNotificationOrientationChange          @"notificationOrientationChange"

#define MAX_PINCH_SCALE_NUM   3.f
#define MIN_PINCH_SCALE_NUM   1.f

@interface SessionCaptureManager : NSObject
...
@property (nonatomic, assign) id<CapturePhotoDelegate> delegate;

-(void) configWithParentLayer:(UIView *)parentView previewRect:(CGRect) previewRect;
...
#import "SessionCaptureManager.h"
#import <ImageIO/ImageIO.h>
#import "UIImage+Resize.h"
#import <QuartzCore/QuartzCore.h>
#import "ALAssetsLibrary+PhotoAlbum.h"

@interface SessionCaptureManager()
@property (nonatomic, strong) UIView *preview;
@end

@implementation SessionCaptureManager
...
- (void)configWithParentLayer:(UIView*)parent previewRect:(CGRect)preivewRect {
...
- (void)switchGrid:(BOOL)toShow {
    ...
    CGFloat headHeight = _previewLayer.bounds.size.height - SCREEN_WIDTH;
    CGFloat squareLength = SCREEN_WIDTH;
    ...
    for (int i = 0; i < 4; i++) {
        ...
        [SessionCaptureManager drawALineWithFrame:frame andColor:[UIColor whiteColor] inLayer:_preview.layer];
    }
}
